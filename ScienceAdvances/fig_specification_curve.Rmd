...
prep_graph <- function(mat, args){
  ...
  df$categ <- with(df, case_when(
                        ...
                        categ == "with_N_TRUE" ~ "Nij not included as covariate",
                        ...
                        categ == "weights_TRUE" ~ "Weight studies equally",
                        categ == "cl_pol_FALSE" ~ "Cluster: level of assignment",
                        categ == "cl_pol_TRUE" ~ "Cluster: politician",
                        categ == "NA_P_recode_FALSE" ~ "P recoded when missing",
                        categ == "NA_P_recode_TRUE" ~ "P dropped when missing",
                        categ == "mex_m10_recode_FALSE" ~ "Mexico: News coded using Q",
                        categ == "mex_m10_recode_TRUE" ~ "Mexico: News coded using posterior-prior",
                        categ == "ug1_m10_recode_FALSE" ~ "Uganda 1: News!=0 when P=Q", 
                        categ == "ug1_m10_recode_TRUE" ~ "Uganda 1: News=0 when P=Q",
                        categ == "bf_m1_recode_FALSE" ~ "Burkina: M1 not recoded",
                        categ == "bf_m1_recode_TRUE" ~ "Burkina: M1=0 when M3=0",
                        categ == "exclude_councilors_FALSE" ~ "Uganda 2: include LCV councilors",
                        categ == "exclude_councilors_TRUE" ~ "Uganda 2: exclude LCV councilors",
                        categ == "exclude_redistrict_FALSE" ~ "Uganda 2: include redistricted councilors",
                        categ == "exclude_redistrict_TRUE" ~ "Uganda 2: exclude redistricted councilors",
                        categ == "exclude_switch_FALSE" ~ "Uganda 2: include party switches",
                        categ == "exclude_switch_TRUE" ~ "Uganda 2: exclude party switches",
                        categ == "contested_seats_FALSE" ~ "Uganda 2: Include uncontested seats",
                        categ == "contested_seats_TRUE" ~ "Uganda 2: Exclude uncontested seats",
